...
Questo capitolo descrive l’ambiente di sviluppo e simulazione adottato per il lavoro di tesi, con l’obiettivo di chiarire il ruolo dei principali strumenti software e il motivo della loro combinazione. L’attenzione è posta sull’architettura concettuale della toolchain, con particolare riferimento all’integrazione tra simulazione a eventi discreti, simulatore di rete, simulatore di traffico, estensioni per il platooning e modellazione cellulare 5G.
