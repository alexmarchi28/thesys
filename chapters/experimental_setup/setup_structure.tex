\section[Struttura delle simulazioni (NED, INI, SUMO)]{Struttura delle simulazioni (NED, INI,\\ SUMO)}
...
Nel workflow adottato, la coerenza tra i file INI e la configurazione SUMO — in particolare per quanto riguarda gli identificativi dei veicoli, la durata della simulazione e il passo temporale — è fondamentale per evitare che la simulazione si avvii correttamente ma produca traiettorie o metriche scorrette.
