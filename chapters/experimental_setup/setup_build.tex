...
Nel caso del tutorial \emph{Example 6} (HetNet), la documentazione ufficiale segnala esplicitamente che il modulo non è più mantenuto nella linea principale di sviluppo; per questa ragione, nella tesi è stato trattato come riferimento logico e non come baseline ``plug-and-play'' \cite{plexe_example6}.
